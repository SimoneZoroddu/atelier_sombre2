        ...
        <header>
            <nav className="navbar navbar-expand-lg background_color_basic mb-2">
                <div className="container-fluid mx-2">
                    <Link className="navbar-brand" to="/"  state={{ scrollPosition: window.scrollY }}>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            </li>
                            {
                                /* 
                                <li className="nav-item underline_hover">
                                    <Link className="nav-link" to="/shoes" state={{ scrollPosition: window.scrollY }} >Informazioni</Link>
                                </li> 
                                */
                            }
                        </ul>
                    </div>
                    <Link to="/wishlist" className="nav-link px-3" state={{ scrollPosition: window.scrollY }}>
                    ...
                    <Link className="nav-link" to="/cart" state={{ scrollPosition: window.scrollY }}>
                        {
                            cartList.length === 0
                                ?
